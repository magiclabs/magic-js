...
const TestModeUpdateEmail = 'magic_auth_update_email_testing_mode';
...
test.serial(`Generate JSON RPC request payload with method ${TestModeUpdateEmail}`, async (t) => {
  ...
  t.is(requestPayload.method, TestModeUpdateEmail);

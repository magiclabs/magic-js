...
# Via pnpm:
pnpm add @magic-sdk/react-native-bare
pnpm add react-native-device-info # Required Peer Dependency
pnpm add @react-native-community/async-storage # Required Peer Dependency

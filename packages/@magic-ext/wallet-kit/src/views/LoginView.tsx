...
export const LoginView = ({ dispatch }: LoginViewProps) => {
  ...
  const { wallets, farcaster } = useWidgetConfig();
  ...
  const showDivider = (hasEmailProvider || socialProviders.length > 0 || farcaster) && wallets.length > 0;
    ...
    <>
      ...
      <VStack w="full" gap={10} mt={2} px={7}>
        ...
        <VStack width="full" maxWidth="25rem" gap={4}>
          ...
          {(socialProviders.length > 0 || farcaster) && (
            <SocialProviders
